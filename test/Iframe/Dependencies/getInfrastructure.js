...
const sampleQuery = { "type": "FeatureCollection", "features": [{ "type": "Feature", "id": "way/731740596", "properties": { "ele": "2082", "gnis:county_id": "069", "gnis:created": "09/01/1994", "gnis:feature_id": "200838", "gnis:state_id": "08", "name": "CedarSpringsDam", "waterway": "dam", "id": "way/731740596" }, "geometry": { "type": "LineString", "coordinates": [[-105.3201746, 40.4618663], [-105.3206545, 40.4610583]] } }] };
...
describe('RenderInfrastructure', function () {
    ...
    describe('renderGeoJson()', function () {
        it('should render geojson onto map', function () {
            assert.deepEqual(Object.keys(getInfrastructure.RenderInfrastructure.renderGeoJson(sampleQuery)._map._targets).length, 2);
        });
    });
    describe('removeFeatureFromMap()', function () {
        it('should remove features from map', function () {
            ...
            assert.deepEqual(Object.keys(getInfrastructure.RenderInfrastructure.map._layers).length, 2);
        });
    });
